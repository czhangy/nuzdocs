...
const AboutPage: React.FC = () => {
    ...
    const getHideDirection = (idx: number) => {
        if (idx === currentPage) {
            return "";
        ...
        <div className={styles["about-page"]}>
            <div className={styles["section-container"]}>
                ...
                >
                    ...
                    <br />
                    <p className={styles.content}>
                        This project will likely never finish development. There are a million things I&apos;d like to
                        add and only so much time for me to add them. At the end of the day, this is a passion project
                        and I&apos;m not a professional Nuzlocker, so, whether it&apos;s due to incompetence or missing
                        data, there&apos;s going to be some wrong information here and there. If you find any, feel free
                        to reach out and I&apos;ll try to fix it ASAP!
                    </p>
                    <br />
                </section>
                <section
                ...
                >
                    ...
                    <p className={styles.content}>
                        Nuzlockes are a fun way to make any Pokémon game more interesting with a set of self-imposed
                        rules that make the game more challenging. The core concepts of a Nuzlocke are 1) if a Pokémon
                        faints, it can no longer be used and 2) only one Pokémon can be caught per area. Any additional
                        rules can be added at the player&apos;s discretion to make the run as fun as possible.
                    </p>
                    <br />
                    <p className={styles.content}>
                        The most common (and my personal favorite) variant of Nuzlockes are &quot;Hardcore
                        Nuzlockes&quot;, which amp the difficulty up even more and generally add rules like the
                        following:
                    </p>
                ...
                >
                    ...
                    <ul className={styles.list}>
                        <li className={styles["bullet-point"]}>
                            A save editor that many use to add items like Rare Candies to your game to minimize grinding
                            and maximize playing
                        </li>
                    </ul>
                    <br />
                    <p className={styles.content}>
                ...
                >
                    ...
                    <p className={styles.content}>
                        ...
                        links at the bottom of the page, especially if you&apos;ve got any feedback or would like to
